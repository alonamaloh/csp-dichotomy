...
\pkey{lem:connected}, \pkey{lem:crucial-split-free} & \textsc{proved} & the
  statement now carries split-freeness of the constraints, without which the
  within-constraint bridges need not exist; both call sites discharge it by
  cruciality, Caveat~\ref{haz:connected-p} \\
...
shape: of its sixty-four statements, forty-two are proved here --- one of them,
...
\pkey{lem:bridge-from-instance}, is stated without proof, and part (1) of the
main induction is an outline whose measure is not yet well founded.
