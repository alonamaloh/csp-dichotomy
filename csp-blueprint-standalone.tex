...
\item \inproof{lem:self-intersection-pc}, now the sole outline under
  \inproof{lem:intersection-good}, which is otherwise written out in full; and
  \inproof{lem:multiply-all-linear}, which is not yet a proof.
\end{itemize}
...
Zhuk, JACM 2020 (1704.01914) & L2, L4 & \textbf{not fetched} \\
