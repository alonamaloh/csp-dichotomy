...
theorems should be attacked (\S\ref{sec:order}), what governs the schedule
(\S\ref{sec:scope}), and the machine-checked layer architecture of the proof
paper (\S\ref{sec:layers}).
...
L3 & strong subuniverses & 28 & 7$^{*}$ & 9, and one claim-debt \\
L4 & instances & 13 & 9 & 5, and one claim-debt \\
...
of \inproof{lem:parallelogram-crucial}, took L3's exports from two to seven
--- \inproof{cor:prop-relations}, \inproof{lem:preserve-linked},
\inproof{lem:typed-above}, \inproof{lem:intersect-all},
...
layer. \emph{It imports nothing}: every one of its 28 statements is the
...
strong-subalgebras Lem.~5.6 (\inproof{lem:tree-coverings}). Debts: five of
its thirteen statements are not proved --- four stated, and
