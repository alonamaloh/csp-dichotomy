...
\item $\cover{\sigma}$ need not be a congruence. It is a subuniverse of
  ...
  redundant otherwise.
\item Existence of $\cover{\sigma}$ needs an argument: the family of
  $\delta\supsetneq\sigma$ stable under $\sigma$ is nonempty (it contains
  $A^{2}$) and, by irreducibility, closed under the intersections that matter,
  so a least element exists. Uniqueness is exactly what irreducibility buys;
