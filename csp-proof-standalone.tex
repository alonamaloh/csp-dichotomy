...
%%  Generated from revision 9c66cf7 on 2026-08-02.
%% =====================================================================
...
otherwise compose it with itself many times''. That is a stabilisation claim
of the same shape as the reflexivisation of Caveat~\ref{haz:reflexivise}, and
like it, nothing here establishes that the stabilised composite is still a
bridge with the properties the rest of the proof uses. It is used only to make
$\proj_{1,3}$ behave, and the case split on $\delta'$ immediately afterwards
does much the same work, so it may well be removable; that has not been
checked.
...
proof cites --- is acyclic, over $99$ statements, $57$ of which carry proofs,
and $134$ edges. That is a check on the arrangement, not on the mathematics,
and it has caught two real cycles: Caveats~\ref{haz:reverse-hom-split} and
\ref{haz:central-critical-split}.
...
\item The two normalisations of Caveat~\ref{haz:rectangularise}, on which
  \pkey{lem:no-cross-bridge} and \pkey{lem:bridge-to-pc} rest, and through
  them the $\TPC$ case of \pkey{thm:stable-intersection}.
