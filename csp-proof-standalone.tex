...
%%  Generated from revision d3fc1d1 on 2026-08-02.
%% =====================================================================
...
proof cites --- is acyclic, over $101$ statements, $60$ of which carry proofs,
and $148$ edges. That is a check on the arrangement, not on the mathematics,
...
\pkey{lem:reverse-hom}, \pkey{lem:bacon-left},
  ...
  & \textsc{proved} & \\
\pkey{lem:self-intersection-pc} & \textsc{outlined} & \textbf{consumed by
  \pkey{lem:intersection-good}}, subsubcase 2A3 \\
\pkey{lem:intersection-good} & \textsc{proved} & both parts written out, with
  ...
  Caveat~\ref{haz:intersection-draft}. Rests on
  \pkey{lem:self-intersection-pc}, which is still an outline \\
...
shape: of its sixty statements, thirty-eight are proved here --- one of them,
\pkey{lem:maximal-mult}, only under Hypothesis~\ref{hyp:maximal-mult} ---
twelve are imported with exact citations, six are outlined, and four are
stated only.
...
\item \pkey{lem:self-\brk intersection-pc}, now the one outline standing
  between \pkey{lem:inter\brk section-good} --- and so much of
  \S\ref{sec:bridge-proofs} onwards --- and a complete proof; and the rewrite
  of \pkey{lem:multiply-all-linear}.
