...
%%  Generated from revision e403370 on 2026-08-02.
%% =====================================================================
...
\item The \emph{set}-valued iteration of Construction~\ref{constr:omega},
  whose condition 3 still replaces a member by all weaker instances
  (Caveat~\ref{haz:omega}); the single-instance case is
  \pkey{lem:weakening-\brk terminates}. The induction measure across expanded
  coverings, listed here until now, is \textbf{not} an open item: no appeal is
  made at a covering, and Caveat~\ref{haz:the-induction}(c) now enumerates the
  seven that are made.
\end{enumerate}
