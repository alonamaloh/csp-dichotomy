...
%%  Generated from revision fd71bb0 on 2026-08-02.
%% =====================================================================
...
to drop by accident; Lemma~\ref{lem:symmetrise}, which has no such hypothesis,
proves its own collapse identity directly rather than citing this one.
\end{hazard}
...
determinacy holds in both directions. With that, the auxiliary relations
\begin{align*}
  \zeta_{1}(x_{1},x_{2},x_{3},x_{4})&=\exists y\;
    \delta(x_{1},y,x_{3},x_{4})\wedge\delta(x_{2},y,x_{3},x_{4}),\\
  \zeta_{2}(x_{1},x_{2},x_{3},x_{4})&=\exists y\;
    \delta(x_{1},x_{2},x_{3},y)\wedge\delta(x_{1},x_{2},x_{4},y)
\end{align*}
are bridges from $\sigma$ to $\sigma$ when they need to be, and
...
(bt) is the reverse-homomorphism step. Factor $f$ as the quotient by its kernel
$\kappa$ followed by an isomorphism; along an isomorphism every clause is
transported, and for the quotient, $f^{-1}(C')=C'\circ\kappa$ and
$f^{-1}(B')=B'\circ\kappa$, so the claim is
Corollary~\ref{cor:prop-from-factor}, whose right-to-left direction is exactly
this statement.
