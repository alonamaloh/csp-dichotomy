...
Lean --- a multi-person-year project, and one that no proof assistant has
attempted. What is offered is its design: a route, precise statements, a
...
instance \emph{inside} (Hazard~\ref{haz:the-induction}). None of these is an
error in the source. All of them are work.
